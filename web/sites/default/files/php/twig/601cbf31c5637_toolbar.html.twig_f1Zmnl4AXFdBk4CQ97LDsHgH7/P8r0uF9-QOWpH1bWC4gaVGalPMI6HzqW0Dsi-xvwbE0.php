...
class __TwigTemplate_c046ff2415cd8548f358a00ac967b8ec472dce70c5f5906339d7abe401903409 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <nav";
        // line 27
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["toolbar_attributes"] ?? null), "addClass", [0 => "toolbar-bar"], "method", false, false, true, 27), 27, $this->source), "html", null, true);
        echo ">
    ...
    ";
        ...
        ";
            $___internal_26fcddcd5dc933795a4a06f8b37a5919e6a7123d020fc79c61fbee4c91e39eb4_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 33
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_spaceless($___internal_26fcddcd5dc933795a4a06f8b37a5919e6a7123d020fc79c61fbee4c91e39eb4_));
            // line 45
            echo "      </div>
    ";
        }
